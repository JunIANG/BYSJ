        ...
        <div class="top">
            ...
            <div class="top-right">
                <ul>
                    ...
                    <li @click="route('/strategy')">攻略分享</li>
                    <li @click="route('/publishStrategy')">发布攻略</li>
                </ul>
                <el-dropdown type="success" size="mini" :hide-on-click="false">
                    <span class="el-dropdown-link" style="cursor: pointer;">
                        关于我的<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item @click.native="route('/contentCenter')">我的攻略</el-dropdown-item>
                        <el-dropdown-item @click.native="route('/save')">我的收藏</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
                <el-button @click="route('/service')" round >供应商服务中心</el-button>
