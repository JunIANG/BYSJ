<template>
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin: 0 5px;">
            <el-row>
                <el-select @change="fetchFreshData" size="small" v-model="hotelRoomQueryDto.hotelId" clearable placeholder="从属酒店">
        ...
        <el-row style="margin: 0 15px;border-top: 1px solid rgb(245,245,245);">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="hotelName" sortable label="酒店名称" width="200px"></el-table-column>
                <el-table-column prop="price" sortable label="价格" width="100px"></el-table-column>
                <el-table-column prop="discount" sortable label="折扣" width="100px">
                    <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        // 获取酒店信息
        fetchUsers() {
            this.$axios.post('/hotel/queryHotelVendor', {}).then(res => {
        ...
        async fetchFreshData() {
            try {
                ...
                const response = await this.$axios.post('/hotelRoom/queryHotelRoom', params);
                const { data } = response;
