    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        ...
        <el-row style="margin: 0 15px;border-top: 1px solid rgb(245,245,245);">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="detail" width="350" label="门票介绍"></el-table-column>
                ...
                <el-table-column prop="createTime" sortable width="200" label="创建时间"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async fetchFreshData() {
            try {
                const response = await this.$axios.post('/scenicTicket/queryScenicTicket');
                const { data } = response;
